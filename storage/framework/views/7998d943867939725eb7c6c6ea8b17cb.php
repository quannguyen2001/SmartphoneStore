    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div id="addBranchModal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="addBranchForm" action="<?php echo e(url('/add_branch')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!-- Your existing form fields go here -->
                        <div class="div_modal_center">
                            <h2 style="font-size: 25px;">Thêm mới chi nhánh</h2>

                            <form action="<?php echo e(url('/add_branch')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="content">
      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
                    ...
                    <div class="breadcrumb">
                        <p><a href="/redirect"><b>Trang chủ </b></a>><a href="<?php echo e(url('quan-ly-chi-nhanh')); ?>"><b style="color: blue;"> Quản lý chi nhánh </b></a></p>
                    </div>
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td style="max-width: 400px; overflow: hidden;  white-space: nowrap; text-overflow: ellipsis;"><?php echo e($branch->link_map); ?></td>
                                    <td>
                                        <div class="button">
                                            <a class="btn btn-primary" href="<?php echo e(url('chinh-sua-chi-nhanh',$branch->id)); ?>"><b>Chỉnh sửa</b></a>
                                        </div>
                                        <div class="button">
                                            <a class="btn btn-danger delete_branch" href="<?php echo e(url('xoa-chi-nhanh',$branch->id)); ?>" data-branch-name="<?php echo e($branch->address); ?>"><b>Xóa</b></a>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <div class="pagination">
                                ...
                                <?php
                                $start = max(1, $branches->currentPage() - 4);
                                $end = min($branches->lastPage(), $branches->currentPage() + 4);
                                ?>
                                ...
                                <?php for($i = $start; $i <= $end; $i++): ?> <a href="<?php echo e($branches->url($i)); ?>" class="<?php echo e($i == $branches->currentPage() ? 'current' : ''); ?>"><?php echo e($i); ?></a>
                                    <?php endfor; ?>
                                    ...
                                    <?php if($end < $branches->lastPage()): ?>
                                        ...
                                        <?php if($branches->currentPage() < $branches->lastPage()): ?>
                            ...
                            <!-- <div class="pagination">
                                <?php echo e($branches->links('pagination::bootstrap-4')); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#searchButton').on('click', function() {
            ...
            window.location.href = '<?php echo e(url("search_branch")); ?>?search=' + encodeURIComponent(searchValue);
        });
    });
    ...
    $(document).ready(function() {
        $(".delete_branch").click(function(e) {
            ...
            if (branchName && !$(this).data('clicked')) {
                Swal.fire({
                    title: 'Xác nhận xóa ',
                    text: 'Bạn có muốn xóa chi nhánh ' + branchName + ' không?',
                    icon: 'question',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                var notification = $("<div class='alert'>" +
                                    ...
                                    'Bạn đã xóa chi nhánh ' + branchName + ' thành công' +
                                    "</div>");
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/branch.blade.php ENDPATH**/ ?>