    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="breadcrumb">
            <p><a href="/redirect"><b>Trang chủ </b></a>><a href="<?php echo e(url('quan-ly-don-hang')); ?>"><b style="color: blue;"> Quản lý đơn hàng </b></a></p>
          </div>
          <div class="div_center">
            <h2 class="h2_font">Quản lý đơn hàng</h2>
            <div class="center">
              <form action="<?php echo e(url('search_order')); ?>" method="get">
                <?php echo csrf_field(); ?>
            ...
            <div class="center">
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-cho-duyet')); ?>">Đơn đang chờ duyệt</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-van-chuyen')); ?>">Đơn đang vận chuyển</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-da-giao-hang')); ?>">Đơn đã giao hàng</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-da-huy')); ?>">Đơn đã hủy</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-chua-thanh-toan')); ?>">Đơn chưa thanh toán</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-da-thanh-toan')); ?>">Đơn đã thanh toán</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-da-thanh-toan-vnpay')); ?>">Đơn đã thanh toán VNPAY</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="">Xem đơn hàng trên VNPAY</a></button>
            </div>
            ...
            <div class="pagination">
              <?php if ($mergedorders->currentPage() > 1) : ?>
                <a href="<?php echo e($mergedorders->previousPageUrl()); ?>">
              ...
              <?php for ($i = $start; $i <= $end; $i++) : ?> <a href="<?php echo e($mergedorders->url($i)); ?>" class="<?php echo e($i == $mergedorders->currentPage() ? 'current' : ''); ?>"><?php echo e($i); ?></a>
              <?php endfor; ?>

              <?php if ($end < $mergedorders->lastPage()) : ?>
                <span>...</span>
              <?php endif; ?>

              <?php if ($mergedorders->currentPage() < $mergedorders->lastPage()) : ?>
                <a href="<?php echo e($mergedorders->nextPageUrl()); ?>">
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/order_pending.blade.php ENDPATH**/ ?>