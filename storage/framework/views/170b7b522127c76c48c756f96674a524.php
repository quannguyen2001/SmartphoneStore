...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('home/css/chitietsanpham.css?version=1.2')); ?>">
...
<body>
    ...
    <section>
                    ...
                    <div class="div_modal_center">
                        ...
                        <div class="content">
                            ...
                            <div class="div_design">
                                ...
                                <input class="text_color" type="text" style="width: 65%;" id="product_id" name="product_id" value="<?php echo e($product->id); ?>" hidden>
                                <input class="text_color" type="text" style="width: 65%;" id="product_id" name="product_id" value="<?php echo e($product->name); ?>" readonly>
                            </div>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="<?php echo e(url('dien-thoai-chinh-hang')); ?>"><b> Điện thoại </b></a>><a href="<?php echo e(url('dien-thoai',$product->brand->slug)); ?>"><b> Điện thoại <?php echo e($product->brand->title); ?> </b></a>><a href=""><b style="color: blue;"> Điện thoại <?php echo e($product->name); ?> </b></a></p>
        </div>

        <!-- Div hiển thị khung sp hot, khuyến mãi, mới ra mắt ... -->
        <div class="chitietSanpham" style="margin-bottom: 10px">
            <h1><b>Điện thoại <?php echo e($product->name); ?></b></h1>
        ...
        <div class="rowdetail group border_product">
            <?php if(count($colors)>0): ?>
            <div class="picture">
                <img id="productImage" width="400px" height="400px" style="object-fit: contain;" src="<?php echo e(asset('product_color_img/' . $colors[0]->image)); ?>">
                <?php if($old_product_price_min): ?>
                <div class="area_old_product">
                    <strong>Điện thoại cũ giá rẻ</strong>
                    <div class="old_product">
                        <div class="old_product_img">
                            <img src="<?php echo e(asset('product_img/' . $product->image)); ?>">
                        </div>
                        <div class="old_product_content">
                            <p><a href="<?php echo e(url('dien-thoai-cu-gia-re',$product->slug)); ?>"><b class="old_product_name">Điện thoại <?php echo e($product->name); ?></b></a></p>
                            <p><b>Giá chỉ từ:</b> <b class="old_product_price"><?php echo e(number_format($old_product_price_min, 0, ',', '.')); ?>₫</b></p>
                            <?php
                                $discountPercentage_OldProduct = round(($product->price - $old_product_price_min) / $product->price * 100);
                            ?>
                            <p style="margin-top: 5px;"><b><span class="old_product_percent">Tiết kiệm: <?php echo e($discountPercentage_OldProduct); ?>%</span></b>  Bảo hành chính hãng</p>
                           
                        </div>
                        <!-- <img src="<?php echo e(asset('home/img/chitietsanpham/icon-tick.png')); ?>"> -->
                        ...
                        <!-- <div id="detailPromo"><?php echo e($product->promotion); ?></div> -->
                    </div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="picture">
                ...
                <div class="area_old_product">
                    ...
                    <div class="old_product">
                        ...
                        <div class="old_product_content">
                            <p><a href="<?php echo e(url('dien-thoai-cu-gia-re',$product->slug)); ?>"><b class="old_product_name">Điện thoại <?php echo e($product->name); ?></b></a></p>
                            <p><b>Giá chỉ từ:</b> <b class="old_product_price"><?php echo e(number_format($old_product->new_price, 0, ',', '.')); ?>₫</b></p>
            ...
            <div class="price_sale">
                <div class="area_price"><strong><?php echo e(number_format($product->price, 0, ',', '.')); ?>₫</strong>
                ...
                <div class="buttons">
                    ...
                    <div class="button_color">
                        <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="color-button <?php if($key === 0): ?> active <?php endif; ?>" data-image="<?php echo e(asset('product_color_img/' . $color->image)); ?>" data-color="<?php echo e($color->color); ?>"><b class="name_color"><?php echo e($color->color); ?></b></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>
                <div class="policy">
                    <div>
                        <img src="<?php echo e(asset('home/img/chitietsanpham/box.png')); ?>">
                        <p>Bộ sản phẩm gồm: <?php echo e($product->accessories); ?> </p>
                    </div>
                    <div>
                        <img src="<?php echo e(asset('home/img/chitietsanpham/icon-baohanh.png')); ?>">
                        <p>Bảo hành chính hãng 12 tháng.</p>
                    </div>
                    <div class="last">
                        <img src="<?php echo e(asset('home/img/chitietsanpham/1-1.jpg')); ?>">
                ...
                <div class="area_order">
                    ...
                    <a class="buy_now">
                        ...
                        <form action="<?php echo e(url('add_cart',$product->id)); ?>" method="post" id="add-to-cart-form">
                            ...
                            <?php if(count($colors)>0): ?>
                            <input type="hidden" name="color" id="selectedColor" value="<?php echo e($colors[0]->color); ?>"> <!-- Sửa tên biến thành $colors -->
                            <?php endif; ?>
                            <input type="submit" value="Giao trong 1 giờ hoặc nhận tại cửa hàng" class="add_product" style="background-color: transparent;border: 0px transparent;color: white;cursor: pointer;" <?php if(Auth::id()): ?> data-product-name="<?php echo e($product->name); ?>" <?php else: ?> onclick="submitForm()" <?php endif; ?>>
                        </form>
                    </a>
                </div>
            ...
            <div class="info_product">
                ...
                <ul class="info">
                    <li>
                        <p><b>Màn hình</b></p>
                        <div><?php echo e($product->screen); ?></div>
                    </li>
                    <li>
                        <p><b>Hệ điều hành</b></p>
                        <div><?php echo e($product->software); ?></div>
                    </li>
                    <li>
                        <p><b>Camera sau</b></p>
                        <div><?php echo e($product->camera_sau); ?></div>
                    </li>
                    <li>
                        <p><b>Camera trước</b></p>
                        <div><?php echo e($product->camera_truoc); ?></div>
                    </li>
                    <li>
                        <p><b>CPU</b></p>
                        <div><?php echo e($product->chip); ?></div>
                    </li>
                    <li>
                        <p><b>RAM</b></p>
                        <div><?php echo e($product->ram); ?></div>
                    </li>
                    <li>
                        <p><b>ROM</b></p>
                        <div><?php echo e($product->rom); ?></div>
                    </li>
                    <li>
                        <p><b>Cổng sạc</b></p>
                        <div><?php echo e($product->port); ?></div>
                    </li>
                    <li>
                        <p><b>SIM</b></p>
                        <div><?php echo e($product->sim); ?></div>
                    </li>
                    <li>
                        <p><b>PIN</b></p>
                        <div><?php echo e($product->pin); ?> mAh</div>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="chitietSanpham" style="margin-bottom: 20px">
            ...
            <div class="rowdetail_youtube group">
                <div class="youtube">
                    ...
                    <br>
                    <iframe width="780px" height="500px" src="https://www.youtube.com/embed/<?php echo e($product->link); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/detail.blade.php ENDPATH**/ ?>