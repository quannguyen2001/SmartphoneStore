...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="<?php echo e(url('thong-tin-tai-khoan')); ?>"><b> Quản lý tài khoản </b></a>><a href=""><b style="color: blue;"> Thông tin đơn hàng </b></a></p>
        </div>
        <div class="contaniner">
            ...
            <div class="div_content" style="height: 300px; width: 80%;">
                <div class="content_item" style="background-color: blue;">
                    <p><b><i class="fa fa-shopping-bag" aria-hidden="true"></i> Tổng số đơn hàng</b></p>
                    <div class="content_number"><?php echo e($count_sum_order); ?></div>
                </div>
                <div class="content_item" style="background-color: red;">
                    <p><b><i class="fa fa-window-close" aria-hidden="true"></i> Số đơn hàng đã hủy</b></p>
                    <div class="content_number"><?php echo e($count_order_cancel); ?></div>
                </div>
                <div class="content_item" style="background-color: orange;">
                    <p><b><i class="fa fa-truck" aria-hidden="true"></i> Số đơn hàng đang vận chuyển</b></p>
                    <div class="content_number"><?php echo e($count_order_transporting); ?></div>
                </div>
                <div class="content_item" style="background-color: green;">
                    <p><b><i class="fa fa-thumbs-up" aria-hidden="true"></i> Số đơn hàng đã giao xong</b></p>
                    <div class="content_number"><?php echo e($count_order_delivered); ?></div>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/account_order.blade.php ENDPATH**/ ?>