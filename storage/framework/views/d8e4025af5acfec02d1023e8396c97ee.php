...
<head>
    ...
    <title>Sản phẩm <?php echo e($text); ?></title>
...
<body>
    ...
    <section>
        ...
        <div class="companyMenu group flexContain">
            ...
            <a href="<?php echo e(url('dien-thoai',$brands->id)); ?>"><img src="<?php echo e(asset('brand_img/' . $brands->image)); ?>"></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <!-- <a href="index.html?company=Apple"><img src="home/img/company/Apple.jpg"></a> -->
        </div>

        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Sản phẩm <?php echo e($text); ?> </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm <?php echo e($text); ?></b></h1>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/product_filter.blade.php ENDPATH**/ ?>