      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="div_center">
            ...
            <div class="center">
              ...
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-da-giao-hang')); ?>">Đơn đã giao hàng</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('quan-ly-don-hang/don-dang-da-huy')); ?>">Đơn đã bị hủy</a></button>
              ...
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('https://sandbox.vnpayment.vn/merchantv2/Home/Dashboard.htm')); ?>">Xem đơn hàng trên VNPAY</a></button>
            </div>
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/order.blade.php ENDPATH**/ ?>