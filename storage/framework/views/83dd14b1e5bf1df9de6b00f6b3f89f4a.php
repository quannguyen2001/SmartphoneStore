                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <?php $__currentLoopData = $stocks;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $stock) : $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                    <tr>
                            ...
                            <div class="pagination">
                                <?php if ($stocks->previousPageUrl()) : ?>
                                    <a href="<?php echo e($stocks->previousPageUrl()); ?><?php echo e($stocks->total() > 1 ? '&search=' . $searchText : ''); ?>">
                                        <i class="fa fa-angle-left"></i>
                                    </a>
                                <?php endif; ?>

                                <?php for ($i = 1; $i <= $stocks->lastPage(); $i++) : ?>
                                    <a href="<?php echo e($stocks->url($i)); ?><?php echo e($stocks->total() > 1 ? '&search=' . $searchText : ''); ?>" class="<?php echo e($i == $stocks->currentPage() ? 'current' : ''); ?>">
                                        <?php echo e($i); ?>
                                ...
                                <?php if ($stocks->nextPageUrl()) : ?>
                                    <a href="<?php echo e($stocks->nextPageUrl()); ?><?php echo e($stocks->total() > 1 ? '&search=' . $searchText : ''); ?>">
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/search_stock.blade.php ENDPATH**/ ?>