...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="<?php echo e(url('dien-thoai-chinh-hang')); ?>"><b> Điện thoại </b></a>><a href=""><b style="color: blue;"> Sản phẩm điện thoại mới </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm điện thoại mới</b></h1>
        </div> <!-- End FilterName -->
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/new_product_detail.blade.php ENDPATH**/ ?>