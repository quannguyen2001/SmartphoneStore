...
<head>
  <title>Đơn hàng mã số <?php echo e($order_id); ?></title>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="breadcrumb">
            <p><a href="/redirect"><b>Trang chủ </b></a>><a href="<?php echo e(url('quan-ly-don-hang')); ?>"><b> Danh sách đơn hàng </b></a>><a href=""><b style="color: blue;"> Thông tin đơn hàng <?php echo e($order_id); ?> </b></a></p>
          </div>
          <div class="div_center">
            <h2 class="h2_font">Thông tin đơn hàng mã số <?php echo e($order_id); ?></h2>
            ...
            <div class="center">
              <table class="center">
                ...
                <tr>
                  <td><img width="100px" height="150px" src="<?php echo e(asset('product_img/' . $order->product->image)); ?>"></td>
                  <td style="width: 200px; height: 45px;"><?php echo e($order->product->name); ?></td>
                  <td style="width: 200px; height: 45px;"><?php echo e($order->color); ?></td>
                  <td style="width: 30px; height: 45px;"><?php echo e($order->quantity); ?></td>
                  <td style="width: 160px; height: 45px;"><?php echo e(number_format($order->price, 0, ',', '.')); ?>₫</td>
                  <td style="width: 160px; height: 45px;"><?php echo e(number_format($order->total, 0, ',', '.')); ?>₫</td>
                  <td style="width: 200px; height: 45px;"><?php echo e(\Carbon\Carbon::parse($order->time)->format('H:i:s d-m-Y')); ?></td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="width: 160px; height: 45px;"><b><?php echo e($totalproduct); ?></b></td>
                  <td style="width: 200px; height: 45px;"><b>Tổng giá trị đơn hàng</b></td>
                  <td style="width: 160px; height: 45px;"><b><?php echo e(number_format($totalprice, 0, ',', '.')); ?>₫</b></td>
                  <td></td>
                ...
                <tr>
                  <td colspan="7">
                    ...
                    <a href="<?php echo e(url('print_pdf',$order_id)); ?>" class="btn btn-primary"><b class="mdi mdi-file-pdf"> Xuất hóa đơn (PDF)</b></a>
                  </td>
                </tr>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/order_detail.blade.php ENDPATH**/ ?>