          ...
          <div class="div_center productList">
            ...
            <div class="center"> <!-- Đổi thẻ div để bọc bảng -->
              <table class="center">
                ...
                <?php $__currentLoopData = $old_products;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $key => $old_product) : $__env->incrementLoopIndices();
              ...
              <div class="pagination">
                <?php echo e($old_products->links('pagination::bootstrap-4')); ?>
          ...
          <div class="div_center orderList hidden">
            ...
            <div class="center"> <!-- Đổi thẻ div để bọc bảng -->
              <table class="center">
                ...
                <?php $__currentLoopData = $order_old_product;
                $__env->addLoop($__currentLoopData);
...
</script><?php /**PATH /var/www/html/SmartphoneStore/resources/views/admin/old_product.blade.php ENDPATH**/ ?>