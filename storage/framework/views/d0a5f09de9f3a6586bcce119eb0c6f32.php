              ...
              <table class="center">
                ...
                <tr>
                  ...
                  <td style="width: 120px; padding-left: 5px;">
                    ...
                    <div class="button">
                      <a class="btn btn-danger delete_old_product" href="<?php echo e(url('xoa-dien-thoai-cu',$old_product->id)); ?>" data-old-product-name="<?php echo e($old_product->product->name); ?>"><b>Xóa</b></a>
                    </div>
          ...
          <div class="div_center orderList hidden">
            ...
            <div class="center"> <!-- Đổi thẻ div để bọc bảng -->
              <table class="center">
                ...
                <?php $__currentLoopData = $order_old_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($key+1); ?></td>
                  ...
                  <td style="width: 120px; padding-left: 5px;">
                    <div class="button">
                      ...
                      document.getElementById('update-payment-form-<?php echo e($order->id); ?>').submit();
                          " class="btn btn-primary" href="#"><b>Khách đã mua</b></a>

                      <form id="update-payment-form-<?php echo e($order->id); ?>" action="<?php echo e(url('update_order_old_product_done', $order->id)); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                      </form>
                    ...
                    <div class="button">
                      <a class="btn btn-danger delete_order_old_product" href="<?php echo e(url('xoa-khach-dat-hang',$order->id)); ?>" data-order-old-product-name="<?php echo e($order->user_name); ?>"><b>Xóa</b></a>
                    </div>
              ...
              <div class="pagination">
                <?php echo e($order_old_product->links('pagination::bootstrap-4')); ?>
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/old_product.blade.php ENDPATH**/ ?>