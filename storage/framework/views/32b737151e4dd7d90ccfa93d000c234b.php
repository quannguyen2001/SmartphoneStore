                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <?php $__currentLoopData = $branches;
                                ...
                                foreach ($__currentLoopData as $branch) : $__env->incrementLoopIndices();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="button">
                                                <a class="btn btn-danger delete_branch" href="<?php echo e(url('xoa-hang', $branch->id)); ?>" data-branch-name="<?php echo e($branch->address); ?>"><b>Xóa</b></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach;
                            ...
                            <div class="pagination">
                                <?php if ($branches->previousPageUrl()) : ?>
                                    <a href="<?php echo e($branches->previousPageUrl()); ?><?php echo e($branches->total() > 1 ? '&search=' . $searchText : ''); ?>">
                                        <i class="fa fa-angle-left"></i>
                                    </a>
                                <?php endif; ?>

                                <?php for ($i = 1; $i <= $branches->lastPage(); $i++) : ?>
                                    <a href="<?php echo e($branches->url($i)); ?><?php echo e($branches->total() > 1 ? '&search=' . $searchText : ''); ?>" class="<?php echo e($i == $branches->currentPage() ? 'current' : ''); ?>">
                                        <?php echo e($i); ?>

                                    </a>
                                <?php endfor; ?>

                                <?php if ($branches->nextPageUrl()) : ?>
                                    <a href="<?php echo e($branches->nextPageUrl()); ?><?php echo e($branches->total() > 1 ? '&search=' . $searchText : ''); ?>">
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/search_branch.blade.php ENDPATH**/ ?>