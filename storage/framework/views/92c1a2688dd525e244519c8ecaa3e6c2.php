...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('home/css/vnpay_return.css?version=1.1')); ?>">
    ...
    <section>
        ...
        */
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Thông tin thanh toán </b></a></p>
        </div>
        <div class="container">
            ...
            <div class="payment_info">
                ...
                <div class="payment_info_item">
                    ...
                    <label><?php echo e(number_format($_GET['vnp_Amount']/100, 0, ',', '.')); ?>₫</label>
                </div>  
                <div class="payment_info_item">
                ...
                <div class="payment_info_item">
                    ...
                    <label><?php echo e(\Carbon\Carbon::parse($_GET['vnp_PayDate'])->format('H:i:s d-m-Y')); ?></label>
                </div> 
                <div class="payment_info_item">
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/vnpay_return.blade.php ENDPATH**/ ?>