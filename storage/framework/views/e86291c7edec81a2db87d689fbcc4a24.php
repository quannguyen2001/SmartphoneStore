                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="button">
                                            <a class="btn btn-danger delete_stock" href="<?php echo e(url('xoa-kho',$stock->id)); ?>" data-stock-name="<?php echo e($stock->product->name); ?> ở <?php echo e($stock->branch->address); ?>, <?php echo e($stock->branch->district); ?>, <?php echo e($stock->branch->city); ?>"><b>Xóa</b></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="pagination">
                                <?php if($stocks->currentPage() > 1): ?>
                                <a href="<?php echo e($stocks->previousPageUrl()); ?>">
                                ...
                                <?php for($i = $start; $i <= $end; $i++): ?> <a href="<?php echo e($stocks->url($i)); ?>" class="<?php echo e($i == $stocks->currentPage() ? 'current' : ''); ?>"><?php echo e($i); ?></a>
                                    <?php endfor; ?>

                                    <?php if($end < $stocks->lastPage()): ?>
                                        <span>...</span>
                                        <?php endif; ?>

                                        <?php if($stocks->currentPage() < $stocks->lastPage()): ?>
                                            <a href="<?php echo e($stocks->nextPageUrl()); ?>">
                                                <i class="fa fa-angle-right"></i>
                                            </a>
                                            <?php endif; ?>
                            </div>
                            <!-- <div class="pagination">
                                <?php echo e($stocks->links('pagination::bootstrap-4')); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#searchButton').on('click', function() {
            ...
            window.location.href = '<?php echo e(url("search_stock")); ?>?search=' + encodeURIComponent(searchValue);
        });
    });
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/stock.blade.php ENDPATH**/ ?>