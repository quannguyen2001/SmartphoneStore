...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="<?php echo e(url('thong-tin-tai-khoan')); ?>"><b> Quản lý tài khoản </b></a>><a href=""><b style="color: blue;"> Thống kê chi tiêu </b></a></p>
        </div>
        <div class="contaniner">
            <div class="sidebar">
                ...
                <a href="<?php echo e(url('thong-tin-tai-khoan')); ?>" class="menu-item" id="thong-tin-tai-khoan">
                    <div class="sidebar_item"><b>Thông tin tài khoản</b></div>
                </a>
                <a href="<?php echo e(url('chinh-sua-thong-tin')); ?>" class="menu-item" id="chinh-sua-thong-tin">
                    <div class="sidebar_item"><b>Chỉnh sửa thông tin</b></div>
                </a>
                <a href="<?php echo e(url('doi-mat-khau')); ?>" class="menu-item" id="doi-mat-khau">
                    <div class="sidebar_item"><b>Đổi mật khẩu</b></div>
                </a>
                <a href="<?php echo e(url('thong-ke-chi-tieu')); ?>" class="menu-item" id="thong-ke-chi-tieu">
                    <div class="sidebar_item"><b>Thống kê chi tiêu</b></div>
                </a>
                <a href="<?php echo e(route('logout')); ?>" class="menu-item" id="dang-xuat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <div class="sidebar_item"><b>Đăng xuất</b></div>
                </a>
            ...
            <div class="div_content" style="height: 300px; width: 80%;">
                <div class="content_item">
                    <p><b>Tổng số đơn hàng</b></p>
                </div>
                <div class="content_item">
                    <p><b>Tổng số sản phẩm đã mua</b></p>
                </div>
                <div class="content_item">
                    <p><b>Tổng chi tiêu</b></p>
                </div>
                <div class="content_item">
                    <p><b>Tổng số sản phẩm đã mua</b></p>
                </div>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/account_statistic.blade.php ENDPATH**/ ?>