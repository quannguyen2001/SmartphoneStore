    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="div_center">
            ...
            <div class="center">
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-cho-duyet')); ?>">Đơn đang chờ duyệt</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-van-chuyen')); ?>">Đơn đang vận chuyển</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-da-giao-hang')); ?>">Đơn đã giao hàng</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-da-giao-hang')); ?>">Đơn đã hủy</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-chua-thanh-toan')); ?>">Đơn chưa thanh toán</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-da-thanh-toan')); ?>">Đơn đã thanh toán</a></button>
              <button class="btn btn-outline-primary" style="color: black; background-color: lightblue; font-weight: bold; width: 140px; height: 45px;"><a href="<?php echo e(url('don-dang-da-thanh-toan-vnpay')); ?>">Đơn đã thanh toán VNPAY</a></button>
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/order_approval.blade.php ENDPATH**/ ?>