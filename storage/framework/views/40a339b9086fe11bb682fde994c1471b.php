...
<head>
    ...
    <title>Điện thoại <?php echo e($name_old_product->product->name); ?> cũ</title>
...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="<?php echo e(url('dien-thoai-cu')); ?>"><b> Điện thoại cũ </b></a>><a href=""><b style="color: blue;"> Điện thoại <?php echo e($name_old_product->product->name); ?> cũ </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm điện thoại <?php echo e($name_old_product->product->name); ?> cũ</b></h1>
        </div> <!-- End FilterName -->
        ...
        <ul id="products" class="homeproduct group flexContain">
            ...
            <?php $__currentLoopData = $old_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $old_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="sanPham">
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/old_product.blade.php ENDPATH**/ ?>