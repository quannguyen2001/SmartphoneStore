...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('home/css/tuyendung.css?version=1.0')); ?>">
    <!-- js -->
...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Tuyển dụng </b></a></p>
        </div>
        <div class="container">
            <div class="body-tuyendung">
                ...
                <div class="tuyendung-info">
                    ...
                    <ul class="tuyendung-noidung">
                        ...
                        <li>Hoặc nộp hồ sơ trực tiếp tại <b>Phòng Hành chính nhân sự - 55 Giải Phóng, phường Đồng Tâm, Hai Bà Trưng, Hà Nội.</b></li>
                        <li>Hoặc gửi CV qua email:<b> thegioidienthoai@gmail.com</b></li>
                    </ul>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/recruitment.blade.php ENDPATH**/ ?>