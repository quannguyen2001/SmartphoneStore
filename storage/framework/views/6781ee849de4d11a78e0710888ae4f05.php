      ...
      <div class="menu-select-item"><a href="<?php echo e(url('quan-ly-dien-thoai-cu')); ?>">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="div_center">
            ...
            <div class="center"> <!-- Đổi thẻ div để bọc bảng -->
              <table class="center">
                ...
                <tr>
                  ...
                  <td style="width: 120px; padding-left: 5px;">
                    ...
                    <div class="button">
                      <a class="btn btn-danger delete_color" href="<?php echo e(url('xoa-hinh-anh',$color->id)); ?>" data-color-name="<?php echo e($color->product->name); ?> màu <?php echo e($color->color); ?>"><b>Xóa</b></a>
                    </div>
              ...
              <div class="pagination">
                <?php if($colors->currentPage() > 1): ?>
                <a href="<?php echo e($colors->previousPageUrl()); ?>">
                ...
                <?php for($i = $start; $i <= $end; $i++): ?> <a href="<?php echo e($colors->url($i)); ?>" class="<?php echo e($i == $colors->currentPage() ? 'current' : ''); ?>"><?php echo e($i); ?></a>
                  <?php endfor; ?>

                  <?php if($end < $colors->lastPage()): ?>
                    <span>...</span>
                    <?php endif; ?>

                    <?php if($colors->currentPage() < $colors->lastPage()): ?>
                      <a href="<?php echo e($colors->nextPageUrl()); ?>">
...
</script><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/admin/image.blade.php ENDPATH**/ ?>