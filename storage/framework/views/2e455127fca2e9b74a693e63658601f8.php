...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Tìm kiếm sản phẩm </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm có từ khóa "<?php echo e($searchText); ?>"</b></h1>
            <h1 style="font-size: 15px;"><b>Tìm thấy <?php echo e($count_result); ?> kết quả</b></h1>
        </div> <!-- End FilterName -->
        ...
        <div class="pagination">
            ...
            <a href="<?php echo e($products->previousPageUrl()); ?><?php echo e($products->total() > 1 ? '&search=' . $searchText : ''); ?>">
                <i class="fa fa-angle-left"></i>
            </a>
            <?php endif; ?>

            <?php for($i = 1; $i <= $products->lastPage(); $i++): ?>
                <a href="<?php echo e($products->url($i)); ?><?php echo e($products->total() > 1 ? '&search=' . $searchText : ''); ?>" class="<?php echo e($i == $products->currentPage() ? 'current' : ''); ?>">
                    <?php echo e($i); ?>
                ...
                <a href="<?php echo e($products->nextPageUrl()); ?><?php echo e($products->total() > 1 ? '&search=' . $searchText : ''); ?>">
...
</html><?php /**PATH C:\Users\quan\OneDrive - HUCE\Documents\Doc1\Laravel\SmartphoneStore\resources\views/home/search.blade.php ENDPATH**/ ?>