window.onload = function () {
	...
	// addBanner("home/img/banners/banner0.gif", "home/img/banners/banner0.gif");
	// var numBanner = 9; // Số lượng hình banner
	// for (var i = 1; i <= numBanner; i++) {
	// 	var linkimg = "home/img/banners/banner" + i + ".png";
	...
	// ];
	// for (var c of company) addCompany("home/img/company/" + c, c.slice(0, c.length - 4));
...
function addCompany(img, nameCompany) {
	...
	var new_tag = `<a href=` + link + `><img src="home/` + img + `"></a>`;
