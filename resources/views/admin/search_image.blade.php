                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 120px; padding-left: 5px;">
                                        ...
                                        <div class="button">
                                            <a class="btn btn-danger delete_product" href="{{url('xoa-hinh-anh',$color->id)}}" data-product-name="{{$color->name}}"><b>Xóa</b></a>
                                        </div>
                            ...
                            <div class="pagination">
                                ...
                                <a href="{{ $colors->previousPageUrl() }}{{ $colors->total() > 1 ? '&search=' . $searchText : '' }}">
                                    <i class="fa fa-angle-left"></i>
                                </a>
                                @endif

                                @for ($i = 1; $i <= $colors->lastPage(); $i++)
                                    <a href="{{ $colors->url($i) }}{{ $colors->total() > 1 ? '&search=' . $searchText : '' }}" class="{{ $i == $colors->currentPage() ? 'current' : '' }}">
                                        {{ $i }}
                                    </a>
                                    @endfor

                                    @if ($colors->nextPageUrl())
                                    <a href="{{ $colors->nextPageUrl() }}{{ $colors->total() > 1 ? '&search=' . $searchText : '' }}">
