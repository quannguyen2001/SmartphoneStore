                            ...
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 120px; padding-left: 5px;">
                                        ...
                                        <div class="button">
                                            <a class="btn btn-danger delete_old_product" href="{{url('xoa-dien-thoai-cu',$old_product->id)}}" data-old_product-name="{{$old_product->name}}"><b>Xóa</b></a>
                                        </div>
                    ...
                    <div class="div_center orderList hidden">
                        ...
                        <div class="center"> <!-- Đổi thẻ div để bọc bảng -->
                            <table class="center">
                                ...
                                @foreach($order_old_product as $order)
                                <tr>
                                    <td>{{$order->id}}</td>
                                    ...
                                    <td style="width: 120px; padding-left: 5px;">
                                        <div class="button">
                                            ...
                                            <form id="update-payment-form-{{$key}}" action="{{url('update_order_old_product_done', $old_product->id)}}" method="POST" style="display: none;">
                                                @csrf
                                            </form>
