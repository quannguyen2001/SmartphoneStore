    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="menu-select-item"><a href="{{url('quan-ly-dien-thoai-cu')}}">Quản lý điện thoại cũ</a></div> -->
          ...
          <div class="div_center">
            ...
            <div>
              <form action="{{url('search_account')}}" method="get">
                @csrf
            ...
            <table class="center">
              ...
              <tr>
                ...
                <td style="width: 150px; padding-left: 5px;">
                  @if($user->usertype==0)
                  <a class="btn btn-danger delete_user" href="{{url('xoa-tai-khoan',$user->id)}}" data-user-name="{{$user->name}}"><b>Xóa tài khoản</b></a>
                  @endif
                </td>
              </tr>
              @endforeach
