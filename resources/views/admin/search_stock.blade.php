                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="button">
                                            <a class="btn btn-danger delete_branch" href="{{url('xoa-kho',$stock->id)}}" data-branch-name="{{$branch->address}}"><b>Xóa</b></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                            ...
                            <div class="pagination">
                                ...
                                <a href="{{ $stocks->previousPageUrl() }}{{ $stocks->total() > 1 ? '&search=' . $searchText : '' }}">
                                    <i class="fa fa-angle-left"></i>
                                </a>
                                @endif

                                @for ($i = 1; $i <= $stocks->lastPage(); $i++)
                                    <a href="{{ $stocks->url($i) }}{{ $stocks->total() > 1 ? '&search=' . $searchText : '' }}" class="{{ $i == $stocks->currentPage() ? 'current' : '' }}">
                                        {{ $i }}
                                    </a>
                                    @endfor

                                    @if ($stocks->nextPageUrl())
                                    <a href="{{ $stocks->nextPageUrl() }}{{ $stocks->total() > 1 ? '&search=' . $searchText : '' }}">
