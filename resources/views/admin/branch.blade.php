                    ...
                    <div class="div_center">
                        ...
                        <div class="center">
                            <table class="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="button">
                                            <a class="btn btn-danger delete_branch" href="{{url('xoa-chi-nhanh',$branch->id)}}" data-branch-name="{{$branch->address}}"><b>Xóa</b></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                            ...
                            <div class="pagination">
                                ...
                                @for ($i = $start; $i <= $end; $i++) <a href="{{ $branches->url($i) }}" class="{{ $i == $branches->currentPage() ? 'current' : '' }}">{{ $i }}</a>
                                    @endfor
