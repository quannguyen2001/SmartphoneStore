          ...
          <div class="div_center">
            ...
            <div class="center">
              <table class="center">
                ...
                @foreach($total_brand_sale as $key => $totals)
                <tr>
                  <td>{{$key+1}}</td>
                  <td>
                    <img width="150px" src="{{ asset('brand_img/' . $totals->brand_image) }}" alt="image" />
                  </td>
                  <td>{{$totals->brand_title}}</td>
                  <td>{{$totals->product_count}}</td>
                  <td>{{ number_format($totals->product_price, 0, ',', '.') }}₫</td>
                </tr>
                @endforeach
