...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('home/css/lienhe.css?version=1.1') }}">
    <!-- js -->
...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Liên hệ </b></a></p>
        </div>
        <div class="container">
            <div class="body-lienhe">
                ...
                <div class="lienhe-info">
                    <div class="info-left">
                        <p>
                        <h2 style="color: gray"> <b>CÔNG TY CỔ PHẦN THẾ GIỚI ĐIỆN THOẠI</b> </h2><br />
                        <b>Địa chỉ:</b> 55 Giải Phóng, phường Đồng Tâm, Hai Bà Trưng, Hà Nội<br /><br />
                        <b>Hotline:</b> 1900 6688<br /><br />
                        <b>E-mail:</b> thegioidienthoai@gmail.com<br /><br />

                        <b>Quý khách có thể gửi liên hệ tới chúng tôi hotline hoặc gửi email cho chúng tôi. Chúng tôi
                            sẽ trả lời thư của quý khách, xin vui lòng khai báo đầy đủ. Hân hạnh phục vụ và chân thành
                            cảm ơn sự quan tâm, đóng góp ý kiến đến Thế giới điện thoại.</b>
                        <br>
                        <img src="{{asset('home\img\htkt-tgdd-mt_800x450.jpg')}}" width="520px;" style="padding-top: 20px;" alt="">
                        </p>
                    </div>
                    <div class="info-right">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.7334696247194!2d105.84074577479544!3d21.003318488652827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac773026b415%3A0x499b8b613889f78a!2zVHLGsOG7nW5nIMSQ4bqhaSBI4buNYyBYw6J5IEThu7FuZyBIw6AgTuG7mWkgLSBIVUNF!5e0!3m2!1svi!2s!4v1694012451765!5m2!1svi!2s" width="100%" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                        </iframe>
                        <br />
                    </div>
                </div>
