...
<head>
    ...
    <title>Điện thoại {{$brand->title}}</title>
...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="{{url('dien-thoai-chinh-hang')}}"><b> Điện thoại </b></a>><a href=""><b style="color: blue;"> Điện thoại {{$brand->title}} </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm điện thoại {{$brand->title}}</b></h1>
        </div> <!-- End FilterName -->
