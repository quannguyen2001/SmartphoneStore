...
<body>
    ...
    <section>
        ...
        <div class="companyMenu group flexContain">
            ...
            <a href="{{url('dien-thoai',$brands->id)}}"><img src="{{ asset('brand_img/' . $brands->image) }}"></a>
            @endforeach
            <!-- <a href="index.html?company=Apple"><img src="home/img/company/Apple.jpg"></a> -->
        </div>

        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href=""><b style="color: blue;"> Sản phẩm {{$text}} </b></a></p>
        </div>

        <div class="filterName">
            <h1 style="font-size: 25px;"><b>Danh sách sản phẩm {{$text}}</b></h1>
