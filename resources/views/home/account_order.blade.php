...
<body>
    ...
    <section>
        ...
        <div class="breadcrumb">
            <p><a href="/"><b>Trang chủ </b></a>><a href="{{url('thong-tin-tai-khoan')}}"><b> Quản lý tài khoản </b></a>><a href=""><b style="color: blue;"> Thông tin đơn hàng </b></a></p>
        </div>
        <div class="contaniner">
            ...
            <div class="div_content" style="height: 300px; width: 80%;">
                <div class="content_item" style="background-color: blue;">
                    ...
                    <div class="content_number">{{$count_sum_order}}</div>
                </div>
                <div class="content_item" style="background-color: red;">
                    ...
                    <div class="content_number">{{$count_order_cancel}}</div>
                </div>
                <div class="content_item" style="background-color: orange;">
                    ...
                    <div class="content_number">{{$count_order_transporting}}</div>
                </div>
                <div class="content_item" style="background-color: green;">
                    ...
                    <div class="content_number">{{$count_order_delivered}}</div>
                </div>
            </div>
